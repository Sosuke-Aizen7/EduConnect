...
export default function Comparison() {
  ...
  const comparisonRows = [
    { 
      ...
      key: "university", 
      icon: Award,
      getValue: (course: CourseWithUniversity) => course.university.name 
    },
    { 
      label: "Location", 
      key: "location", 
      icon: MapPin,
      getValue: (course: CourseWithUniversity) => `${course.university.city}, ${course.university.country}` 
    },
    { 
      label: "Duration", 
      key: "duration", 
      icon: Clock,
      getValue: (course: CourseWithUniversity) => course.duration 
    },
    { 
      label: "Total Tuition", 
      key: "fees", 
      icon: DollarSign,
      getValue: (course: CourseWithUniversity) => formatFees(course.fees, course.feesType) 
    },
    { 
      label: "Format", 
      key: "format", 
      icon: Users,
      getValue: (course: CourseWithUniversity) => course.format 
    },
    { 
      label: "Credits", 
      key: "credits", 
      icon: Award,
      getValue: (course: CourseWithUniversity) => course.credits ? `${course.credits} credits` : "N/A" 
    },
    { 
      label: "Application Deadline", 
      key: "deadline", 
      icon: Calendar,
      getValue: (course: CourseWithUniversity) => 
    ...
    { 
      ...
      key: "rating", 
      icon: Star,
      getValue: (course: CourseWithUniversity) => course.rating ? `${course.rating}/5.0` : "N/A" 
    },
  ];
